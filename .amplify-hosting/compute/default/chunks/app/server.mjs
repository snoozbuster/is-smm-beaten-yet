import { hasInjectionContext, getCurrentInstance, version, unref, inject, defineAsyncComponent, ref, readonly, mergeProps, defineComponent, provide, shallowReactive, h, Suspense, nextTick, Transition, onMounted, watch, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, n as defu, o as sanitizeStatusCode, q as createHooks } from '../../index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-2da2b0a9.mjs').then((m) => m.default || m)
  },
  {
    name: "levels",
    path: "/levels",
    children: [
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/_levelId_-6eff4af9.mjs').then((m) => m.default || m)
      }
    ],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/levels-ab090e83.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-7ea5cbb2.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-a300482a.mjs').then((r) => r.default));
const LazyPrimeCalendar = defineAsyncComponent(() => import('./_nuxt/calendar.esm-c51f7b6b.mjs').then((r) => r.default));
const LazyPrimeCheckbox = defineAsyncComponent(() => import('./_nuxt/checkbox.esm-b7eb6017.mjs').then((r) => r.default));
const LazyPrimeDropdown = defineAsyncComponent(() => import('./_nuxt/dropdown.esm-767f3e89.mjs').then(function(n) {
  return n.d;
}).then((r) => r.default));
const LazyPrimeInputNumber = defineAsyncComponent(() => import('./_nuxt/inputnumber.esm-c153564c.mjs').then((r) => r.default));
const LazyPrimeInputSwitch = defineAsyncComponent(() => import('./_nuxt/inputswitch.esm-a6e008cf.mjs').then((r) => r.default));
const LazyPrimeInputText = defineAsyncComponent(() => import('./_nuxt/inputtext.esm-ec91fcd7.mjs').then((r) => r.default));
const LazyPrimeMultiSelect = defineAsyncComponent(() => import('./_nuxt/multiselect.esm-6441a746.mjs').then((r) => r.default));
const LazyPrimeTriStateCheckbox = defineAsyncComponent(() => import('./_nuxt/tristatecheckbox.esm-59df796a.mjs').then((r) => r.default));
const LazyPrimeButton = defineAsyncComponent(() => import('./_nuxt/button.esm-6aefb566.mjs').then((r) => r.default));
const LazyPrimeColumn = defineAsyncComponent(() => import('./_nuxt/column.esm-033b4d89.mjs').then((r) => r.default));
const LazyPrimeDataTable = defineAsyncComponent(() => import('./_nuxt/datatable.esm-95bd0c9b.mjs').then((r) => r.default));
const LazyPrimeVirtualScroller = defineAsyncComponent(() => import('./_nuxt/virtualscroller.esm-75fd2f7d.mjs').then((r) => r.default));
const LazyPrimeDialog = defineAsyncComponent(() => import('./_nuxt/dialog.esm-5115bd99.mjs').then((r) => r.default));
const LazyPrimeOverlayPanel = defineAsyncComponent(() => import('./_nuxt/overlaypanel.esm-a620edc5.mjs').then((r) => r.default));
const LazyPrimeMenu = defineAsyncComponent(() => import('./_nuxt/menu.esm-963c489c.mjs').then((r) => r.default));
const LazyPrimeTabMenu = defineAsyncComponent(() => import('./_nuxt/tabmenu.esm-5ab49ab4.mjs').then((r) => r.default));
const LazyPrimeToast = defineAsyncComponent(() => import('./_nuxt/toast.esm-830e7700.mjs').then((r) => r.default));
const LazyPrimeSkeleton = defineAsyncComponent(() => import('./_nuxt/skeleton.esm-cef7bc15.mjs').then((r) => r.default));
const LazyPrimeProgressBar = defineAsyncComponent(() => import('./_nuxt/progressbar.esm-f74b655d.mjs').then((r) => r.default));
const LazyPrimeTag = defineAsyncComponent(() => import('./_nuxt/tag.esm-8f3bcfdc.mjs').then((r) => r.default));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-ff7cbc62.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-9e1c682a.mjs').then((r) => r.default || r));
...
export { BaseStyle as B, ConnectedOverlayScrollHandler as C, DomHandler as D, FilterService as F, ObjectUtils as O, Ripple as R, ToastEventBus as T, UniqueComponentId as U, ZIndexUtils as Z, _export_sfc as _, useToast as a, usePrimeVue as b, createError as c, FilterMatchMode as d, entry$1 as default, __nuxt_component_4 as e, useNuxtApp as f, asyncDataDefaults as g, fetchDefaults as h, useRouter as i, nuxtLinkDefaults as j, useRuntimeConfig as k, injectHead as l, _default as m, navigateTo as n, FilterOperator as o, useStyle as p, BaseDirective as q, resolveUnrefHeadInput as r, primebus as s, useRoute as u };
